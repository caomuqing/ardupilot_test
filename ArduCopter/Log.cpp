...
void Copter::Log_Write_Control_Tuning()
{
    ...
    struct log_Control_Tuning pkt = {
        ...
        time_us             : AP_HAL::micros64(),
        throttle_in         : tera_distance_right, //attitude_control.get_throttle_in(),
        angle_boost         : tera_distance_left, //attitude_control.angle_boost(),
        throttle_out        : roll_velocity_log, //motors.get_throttle(),
        throttle_hover      : target_roll_velocity_log,//motors.get_throttle_hover(),
