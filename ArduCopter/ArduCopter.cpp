...
void Copter::setup() 
{
    ...
    userhook_init(); //mq for teraranger setup
}
...
void Copter::fast_loop()
{
    ...
    //userhook_FastLoop();  //mq for teraranger distance measurement
...
void Copter::throttle_loop()
{
    ...
    //userhook_50Hz(); //mq let it run at 50hz
}
...
void Copter::ten_hz_logging_loop()
{
    ...
    userhook_MediumLoop(); // manually added by mq, to extract sonar data
